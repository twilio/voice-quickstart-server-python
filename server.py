...
#            to_client = 'failed_no_client_map'
    ...
    # client -> PSTN FriendlyName
        if caller.startswith('client'):
            ...
            caller_obj = client.get( caller_instance.sid)
...
def handle_recording():
  ...
  if recording_url is not None:
    ...
    email_message = """"<html xmlns="http://www.w3.org/1999/xhtml"><head><meta http-equiv="Content-Type" content="text/html; charset=utf-8" /><title> Voicemail </title></head><body>"""+'Dear User : A new voicemail has been received: {0}'.format(recording_url)

    delete_message = '<p> The voicemail is accessible to people with the URL. When you no longer need this voice mail, you can simply reply with keyword "Delete" and our system will delete the voice mail. <br> Thank you and Have a Great Day. ' 
